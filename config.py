...
CAL_OBJ_PX_L2R = 400      # L2R Moving Objects, Length of a calibration object in pixels
CAL_OBJ_MM_L2R = 4700    # L2R Moving Objects, Length of the calibration object in millimetres
CAL_OBJ_PX_R2L = 400      # R2L Moving Objects, Length of a calibration object in pixels
...
# Camera Settings
# ---------------
CAMERA = "rtspcam"    # valid values usbcam, rtspcam, pilibcam, pilegcam, filecam 
CAM_LOCATION = "Front Window"
FILECAM_SRC = "video.mp4"
USBCAM_SRC = 0         # Device number of USB connection usually 0, 1, 2, Etc
RTSPCAM_SRC = "rtsp://admin:jon177aa@192.168.1.4:554/h264Preview_01_main"  # Set per IP Cam Docs and config see example below
                                                  # rtsp://admin:mypwd@192.168.1.100:554/12
# Camera Image Stream Settings
IM_SIZE = (2560, 1920)   # Image resolution width, height pixels
...
# AI Settings
# ------------
IM_SAVE_4AI_ON = True                # will save small colour image for later AI processing
...
GUI_THRESH_WIN_ON = True # True=Show openCV cropped BLUR, THRESHOLD grayscale image window. Used for detecting movement contours
GUI_CROP_WIN_ON = True   # True=Show crop window. Same as GUI_THRESH_WIN_ON but in color.
